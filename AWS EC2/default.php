...
<head>
    ...
    <title>Emotion_based Spotify</title>
  ...
  <body >
      ...
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="index.html">
            ...
            <span class="navbar-title">Emotion-based Spotify</span>
          </a>
        </div>
    ...
    <div id='top' class="jumbotron">
      <div class="container-fluid" id="jumbo-dialog">
        <h1 id='attitle' >Emotion-based Spotify</h1>
        <p  class="lead"> A NEW MUSIC THERAPY DESIGNED ESPECIALLY FOR YOU.</p>
        <p id='ttext'>
	   To get started, 1. Take a selfie by clicking the "Take snapshot" button.<br >2. Preview the photo you just took.<br /> 3. Find your playlist by clicking the "Find playlist" button below.<br />
            Then, our Emotion-based spotify will help you find <i>YOUR</i> track!
        </p>
...
<body>
    <div id="results">Your photo is here...</div>
    ...
    <input type ="button" value ="Find your playlist here" onclick = "window.open('http://35.164.157.215/face.php','_blank','height=400,width=400,top=200,left=300')"/>    
        ...
        function take_snapshot() {
            ...
            Webcam.snap( function(data_uri,canvas,context) {
                ...
                document.getElementById('results').innerHTML = 
                    ...
                    '<img src="'+data_uri+'"/>';
            Webcam.upload( data_uri, 'saveim.php', function(code, text){
            // Upload complete!
    ...
    <div id="footer">
      <div class="container text-center">
		...
		Created by @Yuxuan Mao, @Xinyu Li, @Zhuoli Peng</a>.
                        </p>
      </div>
    </div>
...
function loginWithSpotify() {
    ...
    var redirect_uri = 'http://www.ec601spotify.com';
    var scopes = 'playlist-modify-public';

    if (document.location.hostname == 'localhost') { redirect_uri = 'http://localhost:8000/index.html';
    }
